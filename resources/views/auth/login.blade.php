      ...
      <div class="col-xl-10 col-lg-12 col-md-9 mt-5">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5"> 
          <div class="card-body p-0">
            ...
            <div class="row">
            <div class="col-lg-6 d-none d-lg-block " style="background-image: url('/public/backend/img/logo.png');"></div>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user"  method="POST" action="{{ route('confirmPassword.confirm') }}">
                    @csrf
