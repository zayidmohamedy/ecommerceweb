    ...
    <table class="table table-bordered table-stripe">
      ...
      @endphp
        <tr>
          ...
          <td><span>Tk{{number_format($cart->price,2)}}</span></td>
        </tr>
      @endforeach
      </tbody>
      <tfoot>
        <tr>
          ...
          <th scope="col"> <span>Tk{{number_format($order->sub_total,2)}}</span></th>
        </tr>
      ...
      @endif --}}
        <tr>
          ...
          <th><span>Tk{{number_format($order->delivery_charge,2)}}</span></th>
        </tr>
        <tr>
          <th scope="col" class="empty"></th>
